...
namespace RogueTraderSystemGenerator
{
    ...
    public partial class MainWindow
    {
        ...
        private void EditDescriptionClick(object sender, RoutedEventArgs e)
        {
            ...
            DescriptionDialog dlg = new DescriptionDialog { ShowInTaskbar = true, MessageToUser = { Text = "Please enter a description for this node." }, UserInput = { Text = node.Description } };
            dlg.ShowDialog();
            if (dlg.DialogResult == true)
            {
