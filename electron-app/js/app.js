...
class App {
    ...
    handleMenuAction(action, data) {
        // Wrap menu action handling with error handler
        const wrappedHandler = window.errorHandler.wrap(() => {
            switch (action) {
                case 'new-workspace':
                    window.workspace.newWorkspace();
                    break;
    ...
    generateNewStarship() {
        try {
            ...
            window.errorHandler.handle('Generate Starship', error);
        }
    }
    ...
    generateNewPrimitiveSpecies() {
        try {
            ...
            window.errorHandler.handle('Generate Primitive Species', error);
        }
    }
    ...
    generateNewXenos(worldType) {
        try {
            ...
            window.errorHandler.handle('Generate Xenos', error);
        }
    }
    ...
    generateNewTreasure(treasureType) {
        try {
            ...
            window.errorHandler.handle('Generate Treasure', error);
        }
    }
